...
def main(args):
    ...
    m = args.m
    lam_b = args.lam_b
    net = DRM(input_dim=2,output_dim=1,m=m) 
    if args.pretrained:
...
if __name__ == "__main__":
    ...
    parser.add_argument('--lam_b', type=float, default=500.0)
    parser.add_argument('--pretrained', type=str, default=False)
    args = parser.parse_args()
    main(args)

"""
eps=0.5  33537  L2: 0.010557314825354278 H1: 0.11014349683548949 L_inf: 0.023107675152943784
eps=0.2  33537  L2: 0.030985699991960998 H1: 0.17639696571486024 L_inf: 0.06002699383782732
eps=0.1  132609  L2: 0.038280632519843004 H1: 0.21223989266600135 L_inf: 0.0431206900517129
eps=0.05  132609  L2: 0.04218943100973702 H1: 0.2219130910666112 L_inf: 0.048234956077864245
eps=0.02  527361  L2: 0.06220688152174462 H1: 0.23941235589430923 L_inf: 0.0824622722896885
eps=0.01  527361  L2: 0.0590858048887632 H1: 0.23666128226204058 L_inf: 0.07636969038811044
"""
